...
int main(){
    ...
    total_failures += test_mp_matrix_nonbatch_gemm<double>(cudart);
    total_failures += test_mp_matrix_nonbatch_gemm<float>(cudart);
    total_failures += test_mp_matrix_nonbatch_with_alpha<double>(cudart);
    total_failures += test_mp_matrix_nonbatch_with_alpha<float>(cudart);
    total_failures += test_mp_matrix_nonbatch_with_beta<double>(cudart);
    total_failures += test_mp_matrix_nonbatch_with_beta<float>(cudart);
