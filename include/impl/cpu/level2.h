#ifndef TCGMBLAS_C_LEVEL2_H
#define TCGMBLAS_C_LEVEL2_H
#include "const.h"
...
namespace tcgmtensor{
    ...
    void SymMatrixVectorProduct(const char* T, const size_t m, const size_t n, const float alpha, const float* a, 
                            const float* x, const size_t incx, const float beta, float* y, const size_t incy);
