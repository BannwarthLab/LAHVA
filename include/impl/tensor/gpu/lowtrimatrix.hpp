...
namespace lahva
{
    namespace gpu
    {
        ...
        template <typename T>
        class LowTriMatrix_ : virtual public Tensor_<T>, virtual public cpu::LowTriMatrix_<T>
        {
        public:
        ...
        class LowTriMatrix : virtual public Tensor<T, Allocator, GPUAllocator>, virtual public LowTriMatrix_<T>
        {
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(size_t size, const alloc_ptr &alloc, const gpualloc_ptr &gpualloc) : Tensor<T, Allocator, GPUAllocator>{data_size_(size), alloc, gpualloc}, n_{size}
        {
            check_size_(size);
        }
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(size_t size, T val, const alloc_ptr &alloc, const gpualloc_ptr &gpualloc) : LowTriMatrix(size, alloc, gpualloc)
        {
            check_size_(size);
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(const Shape &shape, const alloc_ptr &alloc, const gpualloc_ptr &gpualloc) : LowTriMatrix(shape.first, alloc, gpualloc)
        {
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(const Shape &shape, T val, const alloc_ptr &alloc, const gpualloc_ptr &gpualloc) : LowTriMatrix{shape.first, val, alloc, gpualloc}
        {
            if (shape.first != shape.second)
            {
                throw std::logic_error("shape.first must be equal to shape.second.");
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(size_t n, const Vector<T, Allocator, GPUAllocator> &data, const alloc_ptr &alloc, const gpualloc_ptr &gpualloc) : LowTriMatrix{n, alloc, gpualloc}
        {
...
#pragma omp for
        ...
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(size_t n, T *data, bool take_ownership, const alloc_ptr &cpualloc, const gpualloc_ptr &gpualloc)
            : Tensor<T, Allocator, GPUAllocator>{cpualloc, gpualloc}, n_{n}
        {
            this->data_ = data;
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(const LowTriMatrix<T, Allocator, GPUAllocator> &other) : Tensor<T, Allocator, GPUAllocator>(static_cast<const Tensor<T, Allocator, GPUAllocator> &>(other)),
                                                                                                                        n_{other.n_}
        {
        }
        ...
        LowTriMatrix<T, Allocator, GPUAllocator> &LowTriMatrix<T, Allocator, GPUAllocator>::operator=(const LowTriMatrix<T, Allocator, GPUAllocator> &other)
        {
            if (this != &other)
            {
                Tensor<T, Allocator, GPUAllocator>::operator=(static_cast<const Tensor<T, Allocator, GPUAllocator> &>(other));
                n_ = other.size();
            }
            return *this;
        }
        ...
        template <typename T, class Allocator, class GPUAllocator>
        LowTriMatrix<T, Allocator, GPUAllocator>::LowTriMatrix(LowTriMatrix<T, Allocator, GPUAllocator> &&other) : Tensor<T, Allocator, GPUAllocator>{static_cast<Tensor<T, Allocator, GPUAllocator> &&>(other)}, n_{other.n_}
        {
        }
        ...
        LowTriMatrix<T, Allocator, GPUAllocator> &LowTriMatrix<T, Allocator, GPUAllocator>::operator=(LowTriMatrix<T, Allocator, GPUAllocator> &&other)
        {
            if (this != &other)
            {
                Tensor<T, Allocator, GPUAllocator>::operator=(static_cast<Tensor<T, Allocator, GPUAllocator> &&>(other));
                n_ = other.size();
                other.n_ = 0;
            }
            return *this;
