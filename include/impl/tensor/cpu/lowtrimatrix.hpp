...
namespace lahva
{
    namespace cpu
    {
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(size_t size, const alloc_ptr &alloc) : Tensor<T, Allocator>{data_size_(size), alloc}, n_{size}
        {
            check_size_(size);
        }
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(size_t size, T val, const alloc_ptr &alloc) : LowTriMatrix(size, alloc)
        {
            check_size_(size);
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(const Shape &shape, const alloc_ptr &alloc) : LowTriMatrix(shape.first, alloc)
        {
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(const Shape &shape, T val, const alloc_ptr &alloc) : LowTriMatrix{shape.first, val, alloc}
        {
            if (shape.first != shape.second)
            {
                throw std::logic_error("shape.first must be equal to shape.second.");
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(size_t n, const Vector_<T> &data, const alloc_ptr &alloc) : LowTriMatrix{n, alloc}
        {
...
#pragma omp for
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(const LowTriMatrix<T, Allocator> &other) : Tensor<T, Allocator>(other),
                                                                                            n_{other.n_}
        {
        }
        ...
        template <typename T, class Allocator>
        LowTriMatrix<T, Allocator>::LowTriMatrix(LowTriMatrix<T, Allocator> &&other) noexcept : Tensor<T, Allocator>{std::move(other)}, n_{other.n_}
        {
        }
